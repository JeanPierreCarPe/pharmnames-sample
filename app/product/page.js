...
const page = () => {
  return (
    <section className="w-screen h-screen bg-white flex">
      <div className="w-2/4 h-screen relative flex flex-col p-16 gap-10">
        <ReturnButton />
        <div className="relative h-full flex flex-col justify-between">
          ...
          <a
            ...
            className="w-full h-[90px] bg-blue-500 rounded-3xl font-poppins font-medium text-xl text-white flex justify-center items-center"
          >
            Shop Now
          </a>
        </div>
      </div>
      <div className="w-2/4 h-screen bg-blue-800 flex flex-col p-16 gap-12">
